...
//            DB::beginTransaction();
            ...
            if (!Capsule::schema()->hasTable($tableNames['roles']))
            ...
            if (!Capsule::schema()->hasTable($tableNames['permissions']))
            ...
            if (!Capsule::schema()->hasTable($tableNames['user_has_roles']))
            ...
            if (!Capsule::schema()->hasTable($tableNames['role_has_permissions']))
